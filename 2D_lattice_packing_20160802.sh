...
sort sil20160720.list > sil20160720.sortedlist;
sort res20160720.list > res20160720.sortedlist;
...
cp res20160801.list backup_res_2.sh
mkdir backupres20160801;
sed -i -e "s/^/cp /" backup_res_2.sh;
sed -i 's#$# ./backupres20160801; #' backup_res_2.sh ;
sh backup_res_2.sh;
...
grep "/gscratch/stf/sunnylin/160624_flatland_finer_sampling/6/" sildir20160801only.sortedlist > res_C2_1_31_2.sh;
grep "/gscratch/stf/sunnylin/160624_flatland_finer_sampling/5/" sildir20160801only.sortedlist > res_C2_2_16_2.sh;
grep "/gscratch/stf/sunnylin/160624_flatland_finer_sampling/4/" sildir20160801only.sortedlist > res_C3_4_1_2.sh;
grep "/gscratch/stf/sunnylin/160624_flatland_finer_sampling/3/" sildir20160801only.sortedlist > res_C3_3_6_2.sh;
grep "/gscratch/stf/sunnylin/160624_flatland_finer_sampling/2/" sildir20160801only.sortedlist > res_C3_2_13_2.sh;
grep "/gscratch/stf/sunnylin/160624_flatland_finer_sampling/1/" sildir20160801only.sortedlist > res_C3_1_12_2.sh;
...
for i in `seq 3`;do qsub submit_packing_2 -W group_list=hyak-stf;done > JOB_IDs_2Dpacking_3;
for i in `seq 3`;do qsub submit_packing_baker -W group_list=hyak-baker;done >> JOB_IDs_2Dpacking_3;
for i in `seq 20`;do qsub submit_packing_2 -q bf;done >> JOB_IDs_2Dpacking_3
